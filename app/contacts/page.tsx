...
const Paragraphs = [
  ...
  {
    text: 'ruslanshamsutdinov.dev@gmail.com',
    icon: <TbMail className={cn('relative top-[1px]')} />,
  },
] as const
...
const Links = [
  {
    text: 'Discord',
    href: 'https://discord.com/users/520239310591492114',
    icon: <FaDiscord />,
  },
  ...
  {
    text: 'LinkedIn',
    href: 'https://www.linkedin.com/in/ruslan-shamsutdinov-dev/',
    icon: <FaLinkedin />,
  },
] as const
    ...
    >
      ...
      <div className={cn('mx-auto lg:mx-0 px-2 pt-4 pb-8 w-full lg:w-auto max-w-md')}>
        ...
        <div className={cn('pt-1.5 pb-4 flex flex-col gap-4 overflow-x-auto')}>
          {Paragraphs.map(({ text, icon }) => (
            <div key={text} className={cn('flex items-center gap-1.5')}>
