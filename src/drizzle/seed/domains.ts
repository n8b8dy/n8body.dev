...
export const DOMAINS = [
  ...
  },
  {
    ...
    technologies: [
      ...
      { slug: 'TANSTACK_ROUTER', name: 'TanStack Router', color: null, featured: true },
      { slug: 'TANSTACK_QUERY', name: 'TanStack Query', color: null, featured: true },
      ...
      { slug: 'THREE_JS', name: 'Three.js', color: null, featured: true },
    ],
  },
  {
    name: 'Mobile',
  ...
  },
  {
    ...
    technologies: [
      ...
      { slug: 'REST_API', name: 'REST API', color: null, featured: true },
  ...
  },
  {
    ...
    technologies: [
      ...
      { slug: 'GITHUB_ACTIONS', name: 'GitHub Actions', color: null, featured: true },
