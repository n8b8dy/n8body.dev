...
export const TanstackSVG = (props: SVGProps) => {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient id="tanstack_b" x1="50%" x2="50%" y1="0%" y2="71.65%">
        ...
        <linearGradient id="tanstack_d" x1="43.996%" x2="53.441%" y1="8.54%" y2="93.872%">
          <stop offset="0%" stopColor="#673800" />
          <stop offset="100%" stopColor="#B65E00" />
        </linearGradient>
        <linearGradient id="tanstack_e" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#2F8A00" />
          <stop offset="100%" stopColor="#90FF57" />
        </linearGradient>
        <linearGradient id="tanstack_f" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#2F8A00" />
          <stop offset="100%" stopColor="#90FF57" />
        </linearGradient>
        <linearGradient id="tanstack_g" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#2F8A00" />
          <stop offset="100%" stopColor="#90FF57" />
        </linearGradient>
        <linearGradient id="tanstack_h" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#2F8A00" />
          <stop offset="100%" stopColor="#90FF57" />
        </linearGradient>
        <linearGradient id="tanstack_i" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#2F8A00" />
          <stop offset="100%" stopColor="#90FF57" />
        </linearGradient>
        <linearGradient id="tanstack_j" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#2F8A00" />
          <stop offset="100%" stopColor="#90FF57" />
        </linearGradient>
        <linearGradient id="tanstack_k" x1="92.9%" x2="8.641%" y1="45.768%" y2="54.892%">
          <stop offset="0%" stopColor="#EE2700" />
          <stop offset="100%" stopColor="#FF008E" />
        </linearGradient>
        <linearGradient id="tanstack_l" x1="61.109%" x2="43.717%" y1="3.633%" y2="43.072%">
          <stop offset="0%" stopColor="#FFF400" />
          <stop offset="100%" stopColor="#3C8700" />
        </linearGradient>
        <linearGradient id="tanstack_m" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#FFDF00" />
          <stop offset="100%" stopColor="#FF9D00" />
        </linearGradient>
        <linearGradient id="tanstack_n" x1="127.279%" x2="0%" y1="49.778%" y2="50.222%">
          <stop offset="0%" stopColor="#FFA400" />
          <stop offset="100%" stopColor="#FF5E00" />
        </linearGradient>
        <linearGradient id="tanstack_o" x1="127.279%" x2="0%" y1="47.531%" y2="52.469%">
          <stop offset="0%" stopColor="#FFA400" />
          <stop offset="100%" stopColor="#FF5E00" />
        </linearGradient>
        <linearGradient id="tanstack_p" x1="127.279%" x2="0%" y1="46.195%" y2="53.805%">
          <stop offset="0%" stopColor="#FFA400" />
          <stop offset="100%" stopColor="#FF5E00" />
        </linearGradient>
        <linearGradient id="tanstack_q" x1="127.279%" x2="0%" y1="35.33%" y2="64.67%">
          <stop offset="0%" stopColor="#FFA400" />
          <stop offset="100%" stopColor="#FF5E00" />
        </linearGradient>
        <linearGradient id="tanstack_r" x1="127.279%" x2="0%" y1="4.875%" y2="95.125%">
          <stop offset="0%" stopColor="#FFA400" />
          <stop offset="100%" stopColor="#FF5E00" />
        </linearGradient>
        <linearGradient id="tanstack_s" x1="78.334%" x2="31.668%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#FFA400" />
          <stop offset="100%" stopColor="#FF5E00" />
        </linearGradient>
        <linearGradient id="tanstack_t" x1="57.913%" x2="44.88%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#FFA400" />
          <stop offset="100%" stopColor="#FF5E00" />
        </linearGradient>
        <linearGradient id="tanstack_u" x1="50.495%" x2="49.68%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#FFA400" />
          <stop offset="100%" stopColor="#FF5E00" />
        </linearGradient>
        <circle id="tanstack_a" cx={308.5} cy={308.5} r={308.5} />
        <circle id="tanstack_v" cx={307.5} cy={308.5} r={316.5} />
      </defs>
      <g fill="none" fillRule="evenodd" transform="translate(9 8)">
        <mask id="tanstack_c" fill="#fff">
          <use xlinkHref="#tanstack_a" />
        </mask>
        <use xlinkHref="#tanstack_a" fill="url(#tanstack_b)" />
        <ellipse
          cx={81.5}
          cy={602.5}
          fill="#015064"
        ...
        <g mask="url(#tanstack_c)">
          <g transform="translate(389 -32)">
            <circle cx={168.5} cy={113.5} r={113.5} fill="url(#tanstack_m)" />
            <circle
              cx={168.5}
              cy={113.5}
              r={106}
